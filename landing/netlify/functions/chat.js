...
const FALLBACK_MESSAGE =
  "Bonjour ! Je suis ParentAtEase. Je ne peux pas répondre pour le moment, mais tu peux rejoindre le service en envoyant « join on-help » au +1 415 523 8886 sur WhatsApp. C'est gratuit pendant le lancement !";

const SYSTEM_PROMPT = `Tu es ParentAtEase, l'assistante virtuelle du service ParentAtEase Parenting Coach sur WhatsApp.
